...
(function () {
  ...
  /* ---------- 通用 Toast（与社交/个人页 showPageToast 同节奏/样式） ---------- */
  ...
  window.openLivePopup = function (opts) {
    ...
    popup.onclick = function (e) {
      ...
      if (act === 'follow') {
        ...
        showDetailToast(following ? '已成功关注～' : '已成功取消关注');
      }
    };
  };
  ...
  function bindEvents(mask) {
    ...
    popup.addEventListener('click', function (e) {
      ...
      switch (act) {
        ...
        case 'follow':
          ...
          btn.textContent = followOn ? '已关注' : '关 注';
          showDetailToast(followOn ? '已成功关注～' : '已成功取消关注');
          break;
    ...
    actions.hidden = true;
    actions.innerHTML = '<span class="dr-input-count">0/70</span><button class="dr-cancel" type="button" data-act="cancel-input">取消</button><button class="dr-send" type="button" data-act="send-comment">发送</button>';
